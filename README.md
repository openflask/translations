...
3. Create a new branch. The name of the branch should be the country code of the language you want to translate into. For example, if you want to translate into German, the name of the branch should be `de`.
Example: ```git checkout -b de```.
...
Example: ```git commit -m "Added German translation"```.
8. Push your changes to your forked repository.
Example: ```git push origin de```.
...
## 📝 License
This repository is licensed under the [Apache License 2.0](https://github.com/flaskyi/translations/blob/main/LICENSE) license.
```license
                                 Apache License
